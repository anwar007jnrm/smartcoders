...
public interface Constants {
    ...
    String BAD_REQUEST_ERROR = "1003";
    String INVALID_MODE_ERROR = "1004";
    String INVALID_CREDENTIALS = "1005";
    String DOCUMENT_ID_NOT_FOUND = "1006";
    String OTP_NOT_FOUND = "1007";
    String SMS_SEND_ERROR = "1008";
    String EMAIL_SEND_ERROR = "1009";
